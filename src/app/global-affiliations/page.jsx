...
export const metadata = {
  title: 'Global Affiliations | CPMS',
  description: 'Our international affiliations extend your reach with trusted partner networks across regions.'
};
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
      ...
      <section id="memberships" className="mt-10">
        ...
        <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {memberships.map((m) => (
            <figure key={m.title} className="aspect-[3/2] rounded-lg border bg-gray-50 flex items-center justify-center text-center p-2" title={m.title} aria-label={m.title}>
              <figcaption>
      ...
      <section className="mb-12">
        ...
        <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {logoTiles.map((l) => (
            <div key={l.title} className={`aspect-[3/2] ${l.bg} rounded-lg border flex items-center justify-center`}
