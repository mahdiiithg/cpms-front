    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 py-2 sm:py-3">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-gray-600">
            ...
            <span className="text-blue-600">Global Affiliations</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Button type="primary" size="large" className="transition-all duration-300 hover:scale-105 hover:shadow-lg" onClick={handleScheduleCall}>
                  Enquire Now
                </Button>
                <Button type="default" size="large" className="transition-all duration-300 hover:scale-105 hover:shadow-lg" href="/dashboard">
                  Explore Portal
                </Button>
              </div>
            </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-6">Our Global Partners</h2>
              ...
              <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                <li className="flex items-start space-x-2"><Shield className="h-4 w-4 text-blue-600 mt-1" /> <span>Trusted introductions to reputable agencies worldwide</span></li>
                <li className="flex items-start space-x-2"><Globe className="h-4 w-4 text-blue-600 mt-1" /> <span>Seamless cross-border coordination for buying, selling, and renting</span></li>
                <li className="flex items-start space-x-2"><Award className="h-4 w-4 text-blue-600 mt-1" /> <span>Curated marketing channels for luxury and investment-grade assets</span></li>
              </ul>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="p-5">
                <h3 className="text-lg font-semibold mb-2">Global Brokerage Network</h3>
                <p className="text-gray-600 text-sm">A community of independent firms sharing market intelligence, referrals, and best practices to elevate results for clients.</p>
              </Card>
              <Card className="p-5">
                <h3 className="text-lg font-semibold mb-2">Luxury Alliances</h3>
                <p className="text-gray-600 text-sm">Access to high-profile publications, private buyer pools, and international showcases for premium properties.</p>
              </Card>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-6">We're Local. We're Global</h2>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">Our Clients</h2>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div>
              ...
              <Button type="primary" className="transition-all duration-300 hover:scale-105 hover:shadow-lg" href="/buy">
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">Why choose our global team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[{
              icon: <CheckCircle className="h-7 w-7 text-blue-600" />, title: 'Single point of contact',
              desc: 'Work with one dedicated consultant who orchestrates every moving part across borders.'
            },{
              icon: <Globe className="h-7 w-7 text-blue-600" />, title: 'Real reach, not just listings',
              desc: 'Benefit from real partner intros, not just portal exposure, to move faster with confidence.'
            },{
              icon: <Shield className="h-7 w-7 text-blue-600" />, title: 'Vetted partners',
              desc: 'Only established, reputable firms—protecting your privacy, timelines, and objectives.'
            },{
              icon: <Award className="h-7 w-7 text-blue-600" />, title: 'Marketing that travels',
              desc: 'Tailored campaigns that reach the right audience locally and internationally.'
            }].map((f, i) => (
              <div key={i} className="bg-gray-50 p-5 rounded-lg border border-gray-200 hover:shadow-sm transition-shadow">
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Popular destinations</h2>
          <p className="text-gray-600 text-center mb-6 sm:mb-8">Explore international opportunities across established and emerging markets.</p>
          <div className="flex flex-wrap gap-2 sm:gap-3 justify-center">
            {['Montenegro','Cyprus','Spain','Greece','Portugal','Mauritius'].map((d) => (
              <a key={d} href="/buy" className="px-3 py-1.5 rounded-full bg-white border border-gray-200 text-gray-700 text-sm hover:border-blue-300 hover:text-blue-700 transition-colors">
                {d}
              </a>
            ))}
          </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-white">
        <div className="max-w-5xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center bg-gray-50 border border-gray-200 rounded-xl p-5 sm:p-6">
            <div className="md:col-span-1 flex items-center justify-center">
              <img src="https://images.unsplash.com/photo-1544006659-f0b21884ce1d?w=300&q=80" alt="Global Affiliations Lead" className="w-32 h-32 rounded-full object-cover shadow" />
            </div>
            <div className="md:col-span-2">
              <h3 className="text-xl font-semibold text-gray-900">Global Affiliations Director</h3>
              <p className="text-sm text-gray-600 mb-3">Your point of contact for cross-border sales, introductions, and private placements.</p>
              <div className="flex flex-wrap gap-3 text-sm text-gray-700">
                <span className="inline-flex items-center gap-1"><Users className="h-4 w-4 text-blue-600" /> 70+ markets covered</span>
                <span className="inline-flex items-center gap-1"><MapPin className="h-4 w-4 text-blue-600" /> Based in Miami</span>
                <span className="inline-flex items-center gap-1"><Award className="h-4 w-4 text-blue-600" /> Luxury & investment</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-3 sm:px-4 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">Global Affiliations — FAQs</h2>
          {(() => {
            const faqs = [
            ...
            return (
              <div className="space-y-3 sm:space-y-4">
                {faqs.map((item, idx) => (
                  <div key={idx} className="border border-gray-200 rounded-lg overflow-hidden transition-all duration-200 hover:shadow-sm bg-white">
                    <button className="w-full px-4 sm:px-6 py-3 sm:py-4 text-left flex justify-between items-center hover:bg-gray-50" onClick={() => setExpanded(expanded === idx ? null : idx)}>
                      <span className="font-semibold text-sm sm:text-base text-gray-900">{item.q}</span>
                      <ChevronRight className={`h-4 w-4 text-gray-500 transition-transform ${expanded === idx ? 'rotate-90 text-blue-600' : ''}`} />
                    </button>
                    <div className={`overflow-hidden transition-all duration-300 ${expanded === idx ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                      <div className="px-4 sm:px-6 pb-4 text-sm sm:text-base text-gray-600">{item.a}</div>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-6">Your guide to investing internationally</h2>
              ...
              <Button type="primary" icon={<Download className="h-4 w-4" />} className="transition-all duration-300 hover:scale-105 hover:shadow-lg">
                Download now
              </Button>
            </div>
            <div className="text-center">
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-3 sm:px-4 lg:px-8">
          ...
          <Button type="default" size="large" onClick={handleScheduleCall}>
            Get in Touch
          </Button>
        </div>
      </section>
